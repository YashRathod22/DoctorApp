...
const CustomTextInput = ({ style, placeholder, value, setUserDetails, userDetails, name, errorMsg, type, errorText, onBlur, onFocus, maxLength, onChange, autoCapitalize }: any) => {
