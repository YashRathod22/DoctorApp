...
export const onBlurErrorFirstName = (userDetails: any, setFormValidation: any, formValidation: any) => {
...
export const onChangeFirstName = (userDetails: any, setFormValidation: any, formValidation: any): void => {
    const newFormValidation = { ...formValidation };
...
export const onBlurErrorLastName = (userDetails: any, setFormValidation: any, formValidation: any) => {
    const newFormValidation = { ...formValidation };
    const nameRegex = /^[a-zA-Z ]{2,40}$/
...
export const onChangeLastName = (userDetails: any, setFormValidation: any, formValidation: any): void => {
    const newFormValidation = { ...formValidation };
...
export const onBlurErrorAge = (userDetails: any, setFormValidation: any, formValidation: any) => {
...
export const onChangeAge = (userDetails: any, setFormValidation: any, formValidation: any): void => {
    const newFormValidation = { ...formValidation };
...
export const onBlurErrorGender = (userDetails: any, setFormValidation: any, formValidation: any) => {
...
export const onBlurErrorPhoneNo = (userDetails: any, setFormValidation: any, formValidation: any) => {
...
export const onChangePhoneNo = (userDetails: any, setFormValidation: any, formValidation: any): void => {
    const newFormValidation = { ...formValidation };
...
export const onBlurErrorHeight = (userDetails: any, setFormValidation: any, formValidation: any) => {
...
export const onChangeHeight = (userDetails: any, setFormValidation: any, formValidation: any): void => {
    const newFormValidation = { ...formValidation };
...
export const onBlurErrorWeight = (userDetails: any, setFormValidation: any, formValidation: any) => {
...
export const onChangeWeight = (userDetails: any, setFormValidation: any, formValidation: any): void => {
    const newFormValidation = { ...formValidation };
...
export const onChangeEmail = (userDetails: any, setFormValidation: any, formValidation: any,) => {
    const newFormValidation = { ...formValidation };
    // const emailRegex = /^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/;
    const emailRegex = /^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/
...
export const onBlurErrorReason = (userDetails: any, setFormValidation: any, formValidation: any): void => {
    if (!userDetails.reason && userDetails.reason.length <= 5) {
        setFormValidation({ ...formValidation, errCount: formValidation.errCount + 1, reasonError: true, reasonErrTxt: 'Please mention the reason' })

    } else {
        if (formValidation.errCount > 0 && formValidation.reasonError && formValidation.reason.length > 4) {
            setFormValidation({ ...formValidation, errCount: formValidation.errCount - 1, reasonError: false })
        }
    }
}

export const onChangeReason = (userDetails: any, setFormValidation: any, formValidation: any): void => {
    userDetails.reason.length > 2 ? (setFormValidation({ ...formValidation, reasonError: false, errCount: formValidation.errCount - 1 })) : (
