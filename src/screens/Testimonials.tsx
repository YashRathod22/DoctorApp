import { View, Text, Pressable, StyleSheet, Linking, Dimensions, TouchableOpacity } from 'react-native'
...
const Testimonials = () => {
    const reviews = [
        { key: 1, image: image1, name: 'Tammy J. Perez', description: 'Dr. Xander gets it. From his excellent treatment, curiosity, investigative mind and ability to connect, you know where you stand immediately and what next steps look like.' },
        { key: 2, image: image2, name: 'Sandra N. Dunlap', description: 'Dr. Xander was terrific. Knowledgeable, sensitive, informative… I immediately felt at ease and felt confident in my receiving expert medical care. Staff was great, too. Walked away, very impressed with the overall experience. HIGHLY recommend.' },
        { key: 3, image: image3, name: 'Eleanor G. Hawkins', description: 'Dr. Xander is a great doctor! He’s very understanding and listens to your concerns. He takes time with the patient to help them with their health issues! I highly recommend him to anyone looking for a specialist' },
        { key: 4, image: image4, name: 'Gregory J. Alvarez', description: 'Dr. Xander did a great job with my first ever health exam. She explained everything to me in a very clear manner. She was also kind and friendly. All of the staff was great they were helpful, patient and helped with my insurance.' },
    ]
