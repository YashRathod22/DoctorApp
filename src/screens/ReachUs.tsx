      ...
      <View style={styles.card}>
        ...
        <View style={styles.CardStyle}>
          <MapView
            ...
            initialRegion={{
              latitude: 19.01445577493574,
              latitudeDelta: 0.407813295617051352,
              longitude: 72.86086460575461,
            ...
            zoomTapEnabled>
            {places.map(place => {
              return <Marker key={place.id} coordinate={place.coordinate} />;
            })}
          </MapView>
          <Pressable
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            onPress={() => dialCall(9823238583)}
            style={styles.button}>
            <Text style={styles.buttonTxt}>Call Us</Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => Linking.openURL('mailto:drkajal@gmail.com')}
            style={styles.button}>
